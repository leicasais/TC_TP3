...
\begin{table}[H]
    \centering
    \caption{Mediciones y magnitudes calculadas para la compensación con $C_{\text{real}}=\SI{8,0}{\micro\farad}$.}
...
\begin{table}[H]
    \centering
    \caption{Magnitudes calculadas para la referencia con $C_{\text{teo}}=\SI{7,05}{\micro\farad}$.}
