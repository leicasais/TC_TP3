...
\textcolor{red}{\MakeUppercase{Ecuaciones que desp le pego a algun otro lado: }}
...
Para esta parte del trabajo se analizó el circuito \textcolor{red}{\MakeUppercase{Poner URL llave $S_R$ cerrada}}. Debido a que se trataba de un circuito compuesto únicamente por una resistencia y una fuente de tensión alterna, se obtuvo la potencia reactiva \(Q\) nula.
