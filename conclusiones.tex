...
Finalmente, al simular el circuito, la corriente obtenida fue de aproximadamente \(0{,}8\,A\), mientras que el valor real medido con el amperímetro fue de \(0{,}6\,A\). Esta diferencia, de aproximadamente \(25\%\), se debe a que en la simulación se consideró que las resistencias tenían un comportamiento óhmico ideal, mientras que en la experiencia real se utilizaron lámparas incandescentes. Estas no se comportan como resistencias constantes, ya que la resistencia del filamento varía con la temperatura. Por lo tanto, al calentarse durante el funcionamiento, su resistencia cambia y esto modifica la corriente medida respecto del valor esperado en la simulación.f
...
Al repetir la experiencia anterior pero con un nucleo de aluminio se pudieron observar varios cambios en el comportamiento del circuito. 

\subsection{Diferencias entre los nucleos masisos y laminados}
\newpage